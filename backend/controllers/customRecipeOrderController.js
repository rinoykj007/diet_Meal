...
exports.quoteRecipePrice = async (req, res) => {
    try {
        ...
        await Notification.create({
            ...
            message: `${restaurant.name} has quoted $${price.toFixed(2)} for your custom recipe "${order.recipeDetails.recipeName}"`,
            type: 'info',
            category: 'order',
            relatedOrderId: order._id,
            relatedRestaurantId: restaurant._id,
...
exports.acceptQuote = async (req, res) => {
    try {
        ...
        await Notification.create({
            ...
            message: `Customer accepted your quote of $${order.quotedPrice.toFixed(2)} for "${order.recipeDetails.recipeName}"`,
            type: 'success',
            category: 'order',
            relatedOrderId: order._id,
            relatedRestaurantId: restaurant._id,
