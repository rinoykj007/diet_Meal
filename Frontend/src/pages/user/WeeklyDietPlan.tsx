                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-3 bg-muted rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold">{meal.macros.protein}g</p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground">Carbs</p>
                          <p className="text-lg font-bold">{meal.macros.carbs}g</p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground">Fats</p>
                          <p className="text-lg font-bold">{meal.macros.fats}g</p>
                        </div>
                      </div>
